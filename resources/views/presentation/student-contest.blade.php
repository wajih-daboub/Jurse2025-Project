...
<div class="container mb-5">
    ...
    <table class="table table-bordered mb-4 w-75 mx-auto">
        ...
        <tr>
            <td>Evaluation of Urban Weather Generator for air temperature and urban heat islands simulation over
                Toulouse (France)
            </td>
            <td>Hiba Hamdi (Kermap)</td>
        </tr>
        <tr>
            <td>Impacts of Altered Human Activities due to COVID 19 Lockdown on Air Pollutants and Land Surface
                Temperatures across European Cities
            </td>
            <td>Patricia Glocke (Ruhr-University Bochum)</td>
        </tr>
        <tr>
            <td>Advantages of Polarimetry and Interferometry for Semantic Segmentation of Urban SAR Images with
                Consideration of the Layover
            </td>
    ...
    <p>
        ...
        The result was announced during the <a class="text-decoration-underline" href="social-events.html">Gala
            Dinner</a> and the Best Student Contest
        Paper Awards were granted to Patricia Glocke and Giannis Lantzanakis.
    </p>

    <div class="text-center my-4">
        <img data-enlargeable="" style="cursor: zoom-in" class="w-75 img-enlargeable" src="images/student-contest.png"
             alt="">
    </div>
